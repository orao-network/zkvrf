...
export interface OraoVRFConsumerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "calcGasUsed" | "calcTxValue" | "callbackGasLimit" | "cancelSubscription" | "fundSubscription" | "getSubscription" | "part1" | "part2" | "pendingRequestExists" | "rawFulfillRandomness" | "request" | "seed"): FunctionFragment;
...
export interface OraoVRFConsumer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OraoVRFConsumerInterface;
