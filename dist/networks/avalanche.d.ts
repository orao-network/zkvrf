...
export declare const ORAO_VRF_AVALANCHE_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const ORAO_VRF_AVALANCHE_TESTNET_CONFIG: IEvmNetworkConfig;
/**
 @defaultValue the default Arbitrum configuration
  ...
  ```
 */
export declare const ORAO_VRF_AVALANCHE_CONFIG: IChainConfig;
