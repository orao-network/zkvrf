import { BytesLike, ContractTransaction, providers, Signer } from "ethers";
...
export declare class OraoVRFClient implements IOraoVRFClient {
     ...
     * ```
     */
    static fromSigner(signer: Signer): Promise<OraoVRFClient>;
    /**
     ...
     * ```
     */
    connect(signer: Signer): OraoVRFClient;
    /**
