...
export interface IZKInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "verifyTx", values: [IZK.ProofStruct, PromiseOrValue<BigNumberish>[]]): string;
...
export interface IZK extends BaseContract {
    ...
    functions: {
        verifyTx(proof: IZK.ProofStruct, input: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<[boolean] & {
            r: boolean;
        }>;
    };
    verifyTx(proof: IZK.ProofStruct, input: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {};
    estimateGas: {
        verifyTx(proof: IZK.ProofStruct, input: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        verifyTx(proof: IZK.ProofStruct, input: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
