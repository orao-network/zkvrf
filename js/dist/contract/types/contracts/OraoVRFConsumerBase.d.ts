...
export interface OraoVRFConsumerBaseInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "calcGasUsed" | "callbackGasLimit" | "cancelSubscription" | "fundSubscription" | "getSubscription" | "pendingRequestExists" | "rawFulfillRandomness" | "request"): FunctionFragment;
